...
//    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //new RecycleClickActivity.FetchInfo().execute();
...
//            }
        ...
        protected void onPostExecute(String s)
        {
            ...
            String token =  databaseHelper.getDetails();
            Intent intent = new Intent(LoginActivity.this,RecycleClickActivity.class);
...
//        Intent myIntent = new Intent(this,RecycleClickActivity.class);
